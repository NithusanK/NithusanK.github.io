//WEBD6201 - LAB3 - Group 4
//Nithusan Kumaraguruparan - 100657300
//March 23, 2022
...
(function()
{
    ...
    function CheckLogin(): void
    {
        ...
        if(sessionStorage.getItem("user"))
        {
            ...
            //$("#task-list").remove();
            $("#login").before(
                `<li class="nav-item" id="tasklist"><a class="nav-link" data="task-list"><i class="fas fa-tasks"></i> Task List</a></li>`
            )
